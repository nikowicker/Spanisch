document.addEventListener("DOMContentLoaded", () => {
    const vocabulary = [
        { german: "das Haustier", spanish: "la mascota" },
        { german: "der Großvater", spanish: "el abuelo" },
        { german: "die Großmutter", spanish: "la abuela" },
        { german: "spanisch", spanish: "español" },
        { german: "der Onkel", spanish: "el tío" },
        { german: "er heißt", spanish: "se llama" },
        { german: "er hat", spanish: "él tiene" },
        { german: "ja", spanish: "sí" },
        { german: "nein", spanish: "no" },
        { german: "die Familie", spanish: "la familia" },
        { german: "der Akzent", spanish: "el acento" },
        { german: "der Punkt", spanish: "el punto" },
        { german: "man schreibt", spanish: "se escribe" },
        { german: "wer?", spanish: "¿quién?" },
        { german: "was?", spanish: "¿qué" },
