document.addEventListener("DOMContentLoaded", () => {
    const vocabulary = [
        { german: "die Straße", spanish: "la calle" },
        { german: "der Freund", spanish: "el amigo" },
        { german: "die Freundin", spanish: "la amiga" },
        { german: "der Lehrer", spanish: "el profesor" },
        { german: "die Lehrerin", spanish: "la profesora" },
        { german: "die Kneipe", spanish: "el bar" },
        { german: "das Taxi", spanish: "el taxi" },
        { german: "das Tier", spanish: "el animal" },
        { german: "die Welt", spanish: "el mundo" },
        { german: "mein", spanish: "mi" },
        { german: "die Stadt", spanish: "la ciudad" },
        { german: "der Papa", spanish: "el padre" },
        { german: "die Mama", spanish: "la madre" },
        { german: "die Eltern", spanish: "los padres" },
        { german: "der Bruder", spanish: "el hermano" },
        { german: "die Schwester", spanish: "la hermana" },
        { german: "die Geschwister", spanish: "los hermanos" },
        { german: "der beste Freund", spanish: "el mejor amigo" },
        { german: "die beste Freundin", spanish: "la mejor amiga" }
    ];
