document.addEventListener("DOMContentLoaded", () => {
    const vocabulary = [
    { german: "lustig", spanish: "gracioso,-a" },
    { german: "sich verabreden", spanish: "quedar" },
    { german: "heute Nachmittag", spanish: "esta tarde" },
    { german: "einverstanden", spanish: "vale" },
    { german: "wohnen", spanish: "vivir" },
    { german: "erster", spanish: "primero" },
    { german: "das Bett", spanish: "la cama" },
    { german: "der Tisch", spanish: "la mesa" },
    { german: "der Schrank", spanish: "el armario" },
    { german: "der Computer", spanish: "el ordenador" },
    { german: "die Tür", spanish: "la puerta" }
];
