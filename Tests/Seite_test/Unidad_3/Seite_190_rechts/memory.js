document.addEventListener("DOMContentLoaded", () => {
    const vocabulary = [
    { german: "die U-Bahn", spanish: "el metro" },
    { german: "das Kino", spanish: "el cine" },
    { german: "die Bibliothek", spanish: "la biblioteca" },
    { german: "die Bäckerei", spanish: "la panadería" },
    { german: "das Einkaufszentrum", spanish: "el Centro comercial" },
    { german: "der Park", spanish: "el parque" },
    { german: "das Café", spanish: "la cafetería" },
    { german: "das Restaurant", spanish: "el restaurante" },
    { german: "es gibt", spanish: "hay" },
    { german: "die Wohnung", spanish: "el piso" },
    { german: "das Zimmer", spanish: "la habitación" },
    { german: "das Badezimmer", spanish: "el baño" },
    { german: "die Küche", spanish: "la cocina" },
    { german: "das Wohnzimmer", spanish: "el salón" }
];
