document.addEventListener("DOMContentLoaded", () => {
    const vocabulary = [
        { german: "deshalb", spanish: "por eso" },
        { german: "die Altstadt", spanish: "el centro histórico" },
        { german: "schauen", spanish: "mirar" },
        { german: "der Reiseführer", spanish: "la guía" },
        { german: "über", spanish: "sobre" },
        { german: "der Kilometer", spanish: "el kilómetro" },
        { german: "trinken", spanish: "tomar" },
        { german: "gehen", spanish: "ir" },
        { german: "geradeaus", spanish: "todo recto" },
        { german: "ich gehe", spanish: "voy" },
        { german: "du gehst", spanish: "vas" },
        { german: "er geht", spanish: "va" },
        { german: "wir gehen", spanish: "vamos" },
        { german: "ihr geht", spanish: "vais" },
        { german: "sie gehen", spanish: "van" },
        { german: "das Theater", spanish: "el teatro" },
        { german: "wichtig", spanish: "importante" },
        { german: "der Garten", spanish: "el jardín" },
        { german: "der Palast", spanish: "el palacio" },
        { german: "von", spanish: "desde" },
        { german: "abbiegen", spanish: "girar" },
        { german: "alt", spanish: "antiguo,-a" },
        { german: "zum Schluss", spanish: "al final" }
    ];
