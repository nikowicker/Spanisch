...
// Vokabelliste
const vocabList = [
    { spanish: "el primo", german: "der Cousin" },
    { spanish: "la prima", german: "die Cousine" },
    { spanish: "¿por qué?", german: "warum?" },
    { spanish: "preguntar", german: "fragen" },
    { spanish: "lo siento", german: "Entschuldigung" },
    { spanish: "como", german: "wie" },
    { spanish: "el horror", german: "der Horror" },
    { spanish: "el enemigo", german: "der Feind" },
    { spanish: "tener gracia", german: "lustig sein" },
    { spanish: "la playa", german: "der Strand" },
    { spanish: "el día", german: "der Tag" },
    { spanish: "la emoción", german: "die Aufregung" }
];
...
function getRandomPairs() {
    const selectedPairs = vocabList.sort(() => Math.random() - 0.5).slice(0, 6);
