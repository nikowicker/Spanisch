document.addEventListener("DOMContentLoaded", () => {
    const vocabulary = [
        { german: "er", spanish: "él" },
        { german: "sie", spanish: "ella" },
        { german: "wir", spanish: "nosotros" },
        { german: "ihr", spanish: "vosotros" },
        { german: "das Internet", spanish: "el Internet" },
        { german: "Österreich", spanish: "Austria" },
        { german: "mehr", spanish: "más" },
        { german: "meine", spanish: "mis" },
        { german: "sprechen", spanish: "hablar" },
        { german: "der feste Freund", spanish: "el novio" },
        { german: "die feste Freundin", spanish: "la novia" },
        { german: "der Sohn", spanish: "el hijo" },
        { german: "der Arzt", spanish: "el médico" },
        { german: "die Ärztin", spanish: "la médica" },
