document.addEventListener("DOMContentLoaded", () => {
    const vocabulary = [
        { german: "la Foto", spanish: "das Foto" },
        { german: "la persona", spanish: "die Person" },
        { german: "hablar", spanish: "sprechen" },
        { german: "sus", spanish: "seine" },
        { german: "tus", spanish: "deine" },
        { german: "el fin de semana", spanish: "das Wochenende" },
        { german: "el fin", spanish: "das Ende" },
        { german: "la semana", spanish: "die Woche" },
        { german: "los alpes", spanish: "die Alpen" },
        { german: "tener", spanish: "haben" },
        { german: "allí", spanish: "dort" },
        { german: "el helado", spanish: "das Eis" },
        { german: "tener hambre", spanish: "Hunger haben" },
        { german: "después de", spanish: "danach" },
        { german: "la bici", spanish: "das Fahrrad" },
        { german: "la excursión", spanish: "der Ausflug" },
        { german: "en bicicleta", spanish: "mit dem Fahrrad" }
    ];
