document.addEventListener("DOMContentLoaded", () => {
  const vocabulary = [
    { german: "der Balkon", spanish: "el balcón" },
    { german: "der Flur", spanish: "el pasillo" },
    { german: "das Schlafzimmer", spanish: "el dormitorio" },
    { german: "der Umzug", spanish: "la mudanza" },
    { german: "die Nachbarin", spanish: "la vecina" },
    { german: "komisch", spanish: "raro,-a" },
    { german: "sich befinden", spanish: "estar" },
    { german: "sehr schlecht", spanish: "fatal" },
    { german: "schon", spanish: "ya" },
    { german: "schön", spanish: "bonito,-a" },
    { german: "klein", spanish: "pequeño,-a" },
    { german: "groß", spanish: "grande" },
    { german: "ich befinde mich", spanish: "estoy" }
];
